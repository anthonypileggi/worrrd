...
If you want to make a printable wordsearch book, you can provide a .yml file.
...
Then you can generate a [pdf puzzle book](https://github.com/anthonypileggi/worrrd/blob/master/inst/book.pdf).
```{r, eval = FALSE}
